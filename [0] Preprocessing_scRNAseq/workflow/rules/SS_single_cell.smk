...
rule get_correlation_between_MQD_and_SC:
    ...
    output:
        plotting_csv = "results/Single_species_analysis/all_plotting_tables_cor_MQD/plotting_{SC_sample}_cor_{MQD_group}_{cor_method}.csv"
    params:
...
rule plot_single_sample_data_with_correlation:
    input:
        SS_MQD_plotting_csv = "results/Single_species_analysis/all_plotting_tables_cor_MQD/plotting_{SC_sample}_cor_{MQD_group}_{cor_method}.csv"
    output:
        figure_folder = directory("results/Single_species_analysis/UMAP_with_correlation/{SC_sample}_cor_{MQD_group}_{cor_method}")
    script:
